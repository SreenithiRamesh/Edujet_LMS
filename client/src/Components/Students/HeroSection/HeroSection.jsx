...
const HeroSection = () => {
  ...
  Unlock a universe of learning made to fuel your <span className='text-[#0d47a1]'> passion </span>and <span className='text-[#0d47a1]'> profession.</span>
   
  </h1>

  <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>
  EduJet delivers immersive, flexible, and future-ready education—tailored just for you.
  </p>
